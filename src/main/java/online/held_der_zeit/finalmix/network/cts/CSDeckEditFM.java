...
public class CSDeckEditFM {
    ...
    public static CSDeckEditFM decode(FriendlyByteBuf buffer) {
        CSDeckEditFM msg = new CSDeckEditFM();

        return msg;
    }

    public static void handle(final CSDeckEditFM message, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
